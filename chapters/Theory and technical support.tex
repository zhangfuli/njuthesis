...
\begin{enumerate}[fullwidth,itemindent=2em,label=(\arabic*)]
    ...
    \item Ca节点: fabric-ca\footnotemark[5]\footnotetext[5]{\href{https://github.com/hyperledger/fabric-ca}{fabric-ca github地址}}是一个官方可选的Membership Service Provider组件, 对Fabric网络中各实体(Identity)的数字身份证书进行管理。完成实体身份注册、数字证书的签发续签或吊销;
